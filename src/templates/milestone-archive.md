...
Template for milestone archives at `.orbti/milestones/v{VERSION}-{NAME}.md`.
...
**Pattern:** `.orbti/milestones/v{VERSION}-{NAME}.md`
...
**Reason:** Improve agent context for ORBTI projects
