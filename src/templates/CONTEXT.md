...
**Purpose:** Captures user's vision, goals, and approach before planning. Created by `/orbti:observe`, consumed by `/orbti:refine`.
...
*Created by /orbti:observe, consumed by /orbti:refine.*
```
...
1. User runs `/orbti:observe <project>`
