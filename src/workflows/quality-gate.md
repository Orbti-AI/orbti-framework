...
1. Check if .orbti/config.md exists:
   ```bash
...
Update .orbti/codebase/CONCERNS.md with scan results.
...
---
*Auto-generated by /orbti:quality-gate*
...
Updated: .orbti/codebase/CONCERNS.md
...
<output>
- Updated .orbti/codebase/CONCERNS.md with SonarQube section
